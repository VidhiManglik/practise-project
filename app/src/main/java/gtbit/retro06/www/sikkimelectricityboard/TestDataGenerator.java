...
public class TestDataGenerator {
	...
	public static void main(String[] args) {
		...
		String[] 
		for(int i=0;i<10;i++){
			System.out.println("{\"name\":\""+ TestDataGenerator.getRandomObjectFromArray(NAMES) + "\",\"emailID\":\""+TestDataGenerator.getRandomObjectFromArray(EMAILS)+"\",\"phoneNumber\":\""+TestDataGenerator.getRandomObjectFromArray(PHONE_NUMBERS)+"\"}");
		}
	}
